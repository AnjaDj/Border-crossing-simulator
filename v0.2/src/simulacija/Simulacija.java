...
public class Simulacija {
    ...
    public static void main(String[] args) throws EmptyCollectionException{
        ...
        CarinskiTerminal ct1 = new CarinskiTerminal(false,1);
        CarinskiTerminal ct2 = new CarinskiTerminal(true,2);
        ...
        while(!"E".equals(kontrola)){

                if("P".equals(kontrola)) {
                    Kontrola.pauza = true;
                }
                if("N".equals(kontrola)) {
                    Kontrola.pauza = false;
                    synchronized (Kontrola.lock){
                        Kontrola.lock.notifyAll();
                    }
                }
                kontrola = sc.nextLine();
        }
